...
namespace Czar.UEditor_Core_OSS
{
    public static class UEditorMvcExtension
    {
        ...
        public static void AddCzarUEditorService(this IServiceCollection services,
...
#endif
#if NET35
        public static void AddCzarUEditorService(string configFileRelativePath = "ueditor.json", bool isCacheConfig = true, string basePath = "", string environmentName = "")
        {
            Config.ConfigFile = configFileRelativePath;
            Config.NoCache = isCacheConfig;
